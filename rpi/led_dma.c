...
// modified by John LaRocque 11/05/23 Remove LHK's slice loops
//                                    Re-add input bytes transforms in C
...
#define CHAN_MAXLEDS    220  // Maximum number of LEDs per channel
...
//----------------------------------------------------------------------------
int LED_DMA(int* array, int n_LEDs, int wait_msec)
//----------------------------------------------------------------------------
{
    //for (int m=0;m<40;m++) {printf("array %i %i \n",m,array[m]);}
    // printf("n_LEDs= %i wait_msec= %i\n",n_LEDs,wait_msec);
